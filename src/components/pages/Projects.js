    ...
    return (
        ...
        <div className='projects-Page'>
            <div className='projects-Container'>
                <div className='projects-Wrapper'>
                    <p>
                    <h2>CONSULTING AND 3D PRINTING</h2> 
                    <br></br>
        ...
        <div className='projects-Page'>
            <div className='projects-Container'>
                <div className='projects-Wrapper'>
                    <p>
                    <h2>3D PRINTER DESIGN AND CONSTRUCTION</h2>
                    <br></br>
        ...
        <div className='projects-Page'>
            <div className='projects-Container'>
                <div className='projects-Wrapper'>
                    <p>
                    <h2>PRINTER AND MULTI-MATERIAL UPGRADES</h2>
                    <br></br>
